...
export class HorizontalSc extends Component {
    ...
    async componentDidMount(){
        ...
        if(this.props.gen){
            data = await fetch(`https://api.themoviedb.org/3/trending/movie/day?api_key=66c495981d58ad7b7afefaa4b7de5ede&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`);
        }else{
            data = await fetch(`https://api.themoviedb.org/3/trending/movie/day?api_key=66c495981d58ad7b7afefaa4b7de5ede&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`);
        }
        ...
        if(this.props.gen){
            data = await fetch(`https://api.themoviedb.org/3/trending/tv/day?api_key=66c495981d58ad7b7afefaa4b7de5ede&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`);
        }else{
            data = await fetch(`https://api.themoviedb.org/3/trending/tv/day?api_key=66c495981d58ad7b7afefaa4b7de5ede&language=en-US&sort_by=popularity.asc&include_adult=false&include_video=false&page=1&with_watch_monetization_types=flatrate`);
        }
...
export default withRouter(HorizontalSc)
